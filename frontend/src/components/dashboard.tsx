  ...
  useEffect(() => {
    ...
    async function loadChainData() {
      ...
      try {
        ...
        const allLogs = await rpcRequest<RpcLog[]>("eth_getLogs", [{
          address: deployment.hook,
          // One topic-0 OR query avoids six sequential provider round trips. The selected
          // pool is filtered below because payment events do not carry a pool id.
          topics: [eventTopics],

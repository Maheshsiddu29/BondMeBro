    ...
    <div className={`app-shell theme-${theme}`}>
      ...
      <div className="main-column">
        ...
        <main className="page-content">
          ...
          {screen === "swap" && <SwapScreen isConnected={isConnected} address={address} networkCorrect={networkCorrect} poolConfig={config} onSwitchNetwork={() => switchChain({ chainId: sepolia.id })} swapMode={swapMode} setSwapMode={setSwapMode} swapAmount={swapAmount} setSwapAmount={setSwapAmount} onConnect={connectWallet} onLearn={() => goTo("learn")} />}
...
function getSwapStatus({
  ...
  if (transactionState === "success") return { tone: "success", title: "Swap confirmed", detail: "The bond event will appear after the next data refresh." };

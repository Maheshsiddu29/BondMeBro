    ...
    returns (bytes4, BeforeSwapDelta, uint24)
{
    ...
    uint256 minBondedAmount =
        params.zeroForOne
            ? cfg.minBondedAmount0
            : cfg.minBondedAmount1;
